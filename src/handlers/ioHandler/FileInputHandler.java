...
public class FileInputHandler {
    ...
    public static void inputAllCreaturesToList(ArrayList<Enemy> creatureList, String fileName) throws FileNotFoundException {
    ...
    public static void inputAllWeaponToList(ArrayList<Item> weaponList, String fileName) throws FileNotFoundException {
        Scanner text = new Scanner(new File(url + fileName));
        while((text.hasNext()))
        {
    ...
    public static void inputAllPotionToList(ArrayList<Item> potionList, String fileName) throws FileNotFoundException{
        Scanner text = new Scanner(new File(url + fileName));
        while((text.hasNext())) {
    ...
    public static void inputPositionsToList(ArrayList<int[]> list, String fileName) throws FileNotFoundException{
        int[] xy_cord;
        Scanner text = new Scanner(new File(url + fileName));
